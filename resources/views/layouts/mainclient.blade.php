      ...
      <div class="container mt-3">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" href="/bandingkan">Bandingkan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="/resep">Resep Untukmu</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="/keluhan">Keluhanmu</a>
              </li>
              <li class="nav-item">
